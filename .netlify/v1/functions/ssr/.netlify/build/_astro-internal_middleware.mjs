...
import 'piccolore';
import { o as originPathnameSymbol, A as AstroError, F as ForbiddenRewrite } from './chunks/astro/server_Cq9nmc9H.mjs';
import 'clsx';
import 'html-escaper';
...
const onRequest$1 = defineMiddleware(async ({ locals, request, isPrerendered }, next) => {
  locals.pb = new PocketBase("https://cinematheque.ugo-lippi.fr");
  if (!isPrerendered) {
